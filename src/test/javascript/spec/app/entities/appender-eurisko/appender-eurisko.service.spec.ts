...
describe('Service Tests', () => {
    ...
    describe('AppenderEurisko Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AppenderEuriskoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/appenders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AppenderEurisko', () => {
