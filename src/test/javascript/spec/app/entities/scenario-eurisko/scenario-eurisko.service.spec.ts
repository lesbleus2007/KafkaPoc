...
describe('Service Tests', () => {
    ...
    describe('ScenarioEurisko Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ScenarioEuriskoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/scenarios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ScenarioEurisko', () => {
